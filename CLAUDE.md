...
- implementation_system/ - the main file for this project
- implementation_system/workflows/ - Workflow instruction files (plan English recipties the agent follows)
- implementation_system/output/ - Finished deliverables (drafts, code, designs, etc.) 
- implementation_system/resources/ - Reference docs and templates 